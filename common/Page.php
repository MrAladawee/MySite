...
abstract class Page
{
    ...
    private function showMenu()
    {
		...
		if (isset($_SESSION['login'])){
            print "<div class='menuitem' style = 'background-color: #6d4c41'><a class='l_menuitem' href='/auth.php?exit=1'>Выход из аккаунта</a></div>";
        }
        print "</div>";
    }
    ...
    private function showFooter()
    {
        ...
        print "<div>© Андрей Брюхин, 2023</div>";
        print "</div>";
    }
