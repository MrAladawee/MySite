    ...
    protected function showContent()
    {
        ...
        <form method="post" action="reg.php">
            <table class='auth'>
                ...
                <tr>
                    <td>Логин:</td>
                    <td><input type="text" size="30" maxlength="50" name="login" value="<?php if(isset($_POST['login'])) print($_POST['login']);?>" placeholder="Ваш уникальный идентификатор"></td>
                </tr>
                <tr>
                    <td>Пароль:</td>
                    <td><input type="password" size="30" maxlength="50" name="password" value="<?php if(isset($_POST['password'])) print($_POST['password']);?>" placeholder="Пароль"> </td>
                </tr>
                <tr>
                    <td>Повтор пароля:</td>
                    <td><input type="password" size="30" maxlength="50" name="password2"  value="<?php if(isset($_POST['password2'])) print($_POST['password2']);?>"placeholder="Повтор пароля"> </td>
                </tr>
                <tr>
                    <td>Как Вас зовут:</td>
                    <td><input type="text" size="30" maxlength="100" name="name" value="<?php if(isset($_POST['name'])) print($_POST['name']);?>" placeholder="Ваши фамилия и имя"> </td>
                </tr>
                <tr><td colspan="2" class="tdhead"><input type="submit" value="Зарегистрироваться"></td></tr>
                <tr><td colspan="2" class="tdhead"><a style = 'color: white' href="auth.php">Уже зарегистрированы?</a></td></tr>
            </table>
        </form>
        <?php
    }
